...
public class DataSource {
    ...
    public static StudentRecord addMark(String sid, Float assignments, Float midterm, Float finals) {
        StudentRecord mark = new StudentRecord(sid, assignments, midterm,finals);
        marks.add(new StudentRecord(sid, assignments, midterm,finals));
        return mark;
    }
...
//        marks.add(new StudentRecord("100661743", 100.0f, 97.0f, 92.5f));
